    ...
    return (
        <ScrollView className="flex-1 bg-[#F2F0EF]">
            <View className="px-4 pt-4 pb-24">
                ...
                <TouchableOpacity 
                    className="bg-blue-500 py-4 rounded-lg mb-6 shadow-md"
                    onPress={() => router.push('../views/vehicalQuotation/[id]')}
                >
                    <Text className="text-center text-white font-bold text-base">
                        📊 Create Group Tour Quotation
                    </Text>
                </TouchableOpacity>

                {/* Bookings Title */}
                <Text className="text-lg font-semibold text-gray-800 mb-4">Vehicle Bookings</Text>
