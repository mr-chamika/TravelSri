...
export default function Views() {
            ...
            rooms: [
                {
                    ...
                    pricePerRoom: 5000 // Price per single room per day
                },
                {
                    type: double,
                    capacity: 2, // Total available double rooms
                    pricePerRoom: 8000 // Price per double room per day
                }
            ]
        },
    ];
    ...
    const handleRoomCountChange = (index: number, change: number) => {
        setSelectedRoomCounts(prevCounts => {
            ...
            const updatedCounts = {
                ...prevCounts,
                [index]: Math.max(0, Math.min(newCount, roomCapacity)) // Ensure count is not negative and not more than capacity
            };
            ...
            >
                <View className="w-full gap-5">
                    ...
                    <View>
                        ...
                        <View>
                            <Text className=" text-2xl font-semibold py-1">Choose Rooms</Text>
                            {item.rooms.map((r, i) => (
