 ...
 */
    ...
    const getMap = async () => {
        ...
        try {
            ...
            const res1 = await fetch(`http://192.168.1.150:8080/traveler/map?id=${id.toString()}`)
    ...
    useEffect(() => {
        const getRoutes = async () => {
            ...
            try {
                ...
                const res = await fetch(`http://192.168.1.150:8080/traveler/routes-one?id=${id.toString()}`)
