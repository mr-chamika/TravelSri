...
export default function Views() {
    ...
    const [item, setItem] = useState<{ id: string, image: any, title: string, duration: number, date: string, stats: string, price: number, max: number, current: number, routes: any[] }>({ id: '1', image: pic, title: 'Matara to Colombo', duration: 2, date: '04 june 2020', stats: 'Confirm', price: 5000, max: 20, current: 3, routes: [] })
        ...
        <View>
            ...
            >
                ...
                <View className="w-full gap-5">
                    ...
                    <View className=" w-full">
                        <View className="border-t-2 border-t-gray-200 pt-5">
                        ...
                        <View>
                            {item.routes.map((x, i) => {
                                ...
                                return (
                                    ...
                                    <View key={i}>
                                        <Text className="py-5 font-black">{i + 1}.{x.place} <Text className="mx-5 italic text-gray-500">Arrives {x.arrives}</Text></Text>
                ...
                <View className="self-center flex-row items-center bg-[#FEFA17] w-[95%] h-12 rounded-2xl justify-between px-1 shadow-lg">
                    ...
                    <TouchableOpacity className=" bg-[#84848460] rounded-xl w-[28%]" onPress={() => router.push(`/views/payment/${item.id}`)}>
                        <View className="py-2 px-3 flex-row justify-between w-full ">
                            <Text>Join Trip</Text>
