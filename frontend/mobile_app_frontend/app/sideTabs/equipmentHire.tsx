        ...
        <>
            <View className="w-full gap-3">
                ...
                <View>
                    ...
                    <Text className="text-[22px] font-semibold mx-3 mb-10">Items</Text>
                            ...
                            {items.length > 0 && items.map((item, i) => {
                                return (
                                    <TouchableOpacity key={i} className="w-[83px] items-center " onPress={() => alert(`Contact us - ${item.contact}`)}>
                                        <Image
                                            className="w-[90px] h-[200px] rounded-[23px] shadow-gray-400"
                ...
                <View className="mt-5">
                    ...
                    <Text className="text-[22px] font-semibold mb-10 mx-3">Top Stores</Text>
