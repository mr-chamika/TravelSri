                ...
                <View className='w-full h-full gap-10'>
                    ...
                    <View>
                        ...
                        <View className='items-center mb-5 gap-5'>
                            ...
                            <TextInput className='rounded-xl w-[300px] border-2 border-gray-200 p-4' placeholder='Enter Your Name' onChangeText={setName} />
                            <TextInput className='rounded-xl w-[300px] border-2 border-gray-200 p-4' placeholder='Enter Your Email' onChangeText={setEmail} />
                            <TextInput multiline={true} className='rounded-xl w-[300px] h-[200px] border-2 border-gray-200 p-4' placeholder='Enter Your Name' style={{ textAlignVertical: 'top' }} onChangeText={setDes} />
