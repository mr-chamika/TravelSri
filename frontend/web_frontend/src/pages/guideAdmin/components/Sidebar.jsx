...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', path: '/GuideAdmin' }, 
    { name: 'Registration Requests', path: '/GuideAdmin/RegistrationRequests' },
    // { name: 'Vehicle Management', path: '/GuideAdmin/VehicleManagement' },
    { name: 'Booking Management', path: '/GuideAdmin/BookingManagement' },
    { name: 'Admin Profile', path: '/GuideAdmin/AdminProfile' },
  ];
