...
const BookingManagement = () => {
  ...
  const [bookings, setBookings] = useState([
    ...
    },
    {
      ...
      guide: 'Gihan Ekanayaka',
      date: '2024-01-20',
      status: 'Confirmed',
      amount: 'Rs.5500',
      duration: '6 days',
      baseArea: 'Batticaloa',
      guideArea: 'Trincomalee',
                ...
                <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-900">{booking.guide}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900">{selectedBooking.guide}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-gray-900">{selectedBooking.baseArea}</p>
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Guide Location</label>
                    <div className="flex items-center">
                      <MapPin className="w-4 h-4 text-gray-400 mr-1" />
                      <p className="text-gray-900">{selectedBooking.guideArea}</p>
                    </div>
                  </div>
                </div>
              </div>
