...
const GuideQuotation = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            uploadData.append('guideId', formData.guideId.trim());
            ...
            if (response.ok) {
                ...
                setSuccess(`Guide quotation created successfully! ID: ${result.quotationId}`);
                    ...
                    <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-lg p-6 md:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="pt-4">
                                <button
                                    type="submit"
                                    disabled={loading || !formData.pendingTripId.trim() || !formData.guideId.trim() || !formData.price || !formData.quotationPdf}
                                    className={`w-full py-3 px-6 font-semibold rounded-lg transition-all duration-200 ${
                                        loading || !formData.pendingTripId.trim() || !formData.guideId.trim() || !formData.price || !formData.quotationPdf
