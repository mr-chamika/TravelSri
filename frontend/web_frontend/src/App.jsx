...
import Dashboard from './pages/guideAdmin/Dashboard';
import Pagelayout from './pages/guideAdmin/Pagelayout';
import RegistrationRequests from './pages/guideAdmin/RegistrationRequests';
...
import AdminProfile from './pages/guideAdmin/AdminProfile';
