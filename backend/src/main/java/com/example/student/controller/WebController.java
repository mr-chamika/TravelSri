...
public class WebController {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> loginCondition(@RequestBody Map<String, String> body) {

       Optional<Hotel>  hotel = hotelsRepo.findByUsername(body.get("username"));
        Optional<User> user = userRepo.findByEmail(body.get("username"));
       ...
       if(hotel.isPresent()){
           ...
           Hotel hotelx = hotel.get();

           System.out.println(body.get("username"));
           System.out.println(body.get("password"));

           hotelx.setPassword(body.get("password"));

           return loginHotel(hotelx);
        ...
        if(user.isPresent()){
               ...
               userx.setPassword((body.get("password")));
